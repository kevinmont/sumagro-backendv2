...
import { IntransitDao } from '../intransitDao';

const logger = log4js.getLogger('sumagro.dao.impl.IntransitDaoImpl');

export class IntransitDaoImpl extends AbstractDao implements IntransitDao {
